                ...
                <div className="p-6 bg-gradient-to-b from-[#3A416F]/80 to-[#4A517F]/80 text-white">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="text-sm">{payment.paymentDate ? format(new Date(payment.paymentDate), "dd/MM/yyyy") : 'Fecha no especificada'}</div>
                        </div>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <div className="grid gap-2">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-3">
                                        <div className="font-medium text-gray-900">{payment.client?.name || 'Cliente'} {payment.client?.lastName || ''}</div>
                                        <div className="text-sm text-gray-500">DNI: {payment.client?.dni || 'No especificado'}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="grid gap-3">
                                ...
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="font-medium text-gray-900">{format(
                                        new Date(payment.created_at), "dd/MM/yyyy", { locale: es })}</span>
                                </div>
                            </div>
                        </div>
                    </div>

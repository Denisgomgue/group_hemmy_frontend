...
import { UserFormData, UserEditFormData, UserFormSchema, UserEditFormSchema } from "@/schemas/user-schema"
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="py-4">
                    {/* TODO: Implementar UserForm component */}
                    <div className="text-center text-muted-foreground">
                        Formulario de usuario en desarrollo
                    </div>
                </div>

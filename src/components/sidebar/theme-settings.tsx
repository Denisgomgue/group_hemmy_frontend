...
export function ThemeSettings() {
    const { layoutMode, setLayoutMode, colorScheme, setColorScheme, sidebarColor, setSidebarColor, chatBotEnabled, setChatBotEnabled } = useTheme()
        ...
        <Sheet>
            ...
            <SheetContent className="w-64">
                ...
                <div className="py-6 space-y-6">
                    ...
                    <div className="space-y-4">
                        <Label className="text-sm font-medium">Asistente Virtual</Label>
                        <div className="grid gap-2">
                            <div className="flex items-center justify-between">
                                <Label htmlFor="chatbot" className="text-sm text-muted-foreground">
                        ...
                        <p className="text-xs text-muted-foreground">
                            Habilita un asistente virtual que puede responder preguntas sobre clientes, pagos, dispositivos y más.
                        </p>
                    </div>

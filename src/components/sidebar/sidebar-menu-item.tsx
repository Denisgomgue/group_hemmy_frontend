                        ...
                        <TooltipTrigger asChild>
                            <Button
                                ...
                                className={cn(
                                    ...
                                    !isCollapsed && hasActiveChild && !isActive && "sidebar-active"
                                )}
                                asChild
                                {...props}
                            >
                    ...
                    <SidebarDropdown
                        trigger={
                            <TooltipTrigger asChild>
                                <Button
                                    variant="ghost"
                                    className={cn("w-full justify-center px-2", isActive && "sidebar-active")}
                                >
                ...
                <CollapsibleTrigger asChild>
                    <div className="w-full">
                        <MenuButton
                            className={cn(
                                "w-full",
                                hasActiveChild && !isActive && "sidebar-active",
                                isActive && "sidebar-active"
                            )}
                        />
                    </div>
